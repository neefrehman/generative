...
const AlertModal = styled.div`
  ...
  transform: translate(calc(var(--edgeButtonMargin)), calc(var(--edgeButtonMargin)));
  ...
  return prefersReducedMotion && !isDismissed ? (
    <AlertModal>
      <AlertModalInner>
        ...
        <p>
          It looks like you have set a preference for reduced motion on your device.
          This site is a collection of motion-heavy sketches and graphics, so I
          thought I should add this warning before displaying them. If you are okay
          with this, click the button below to continue.
        </p>

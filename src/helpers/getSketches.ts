 ...
 * @param nodePath An instance on nodes `path` library
 * @param nodeFs An instance on nodes `fs` library
 */
...
/** Gets all archived drafts sketches from the _drafts/archive folder
 * @param nodePath An instance on nodes `path` library
 * @param nodeFs An instance on nodes `fs` library
 */
export const getArchivedArray = (nodePath: typeof path, nodeFs: typeof fs) => {
